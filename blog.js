...
const { data, error } = await supa.from("comments").select("*").eq("post_id", postId).order("created_at", { ascending:true });
...
container.innerHTML += "<p><b>" + (comment.author || "Anônimo") + "</b><br>" + comment.text + "</p><hr>";
